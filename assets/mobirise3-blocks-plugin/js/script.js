(function(a) {
    ...
    if (!a("html").hasClass("is-builder")) {
        0 < a("section.extTestimonials1:not(.extTestimonials5)").length && (a(window).on("resize", function() {
            a("section.extTestimonials1:not(.extTestimonials5)").each(function() {
                var b = [],
                    c = a(this).find(".carousel-item.active").index();
        ...
        a(document).on("add.cards change.cards", function(b) {
            if (a(b.target).hasClass("extTestimonials1") || a(b.target).hasClass("extTestimonials3"))
                if ((0 < window.navigator.userAgent.indexOf("MSIE ") || navigator.userAgent.match(/Trident.*rv\:11\./)) && a(b.target).find(".card-block").each(function() {
                    ...
                    2 > c || (a(b.target).find(".carousel-inner").attr("class", "carousel-inner slides" + c), a(b.target).find(".carousel-item .col-md-12").each(function() {
                        5 == c ? a(this).attr("class", "col-md-12 col-lg-15") : a(this).attr("class", "col-md-12 col-lg-" + 12 / c)
                    }), a(b.target).find(".carousel-item").each(function() {
        ...
        a(document).ready(function() {
            ...
            }), a(".extProgressBarRound").viewportChecker({
                offset: 150,
                callbackFunction: function(b, c) {
                    a("#" + b.attr("id") + " .pie_progress").asPieProgress("start")
                }
            }))
        });
        a(document).ready(function() {
        ...
        a(document).on("add.cards change.cards", function(b) {
            ...
            if (b.hasClass("extTable1")) {
                var c = b.find(".table-wrapper"),
                    e = "true" === c.attr("data-search");
                if (e) var d = c.attr("search-text"),
                    g = c.attr("info1-text"),
                    m = c.attr("info2-text"),
                    k = c.attr("info3-text"),
                    h = c.attr("info4-text");
    ...
    a(document).on("add.cards", function(b) {
        if (a(b.target).find(".panel-group, .toggle-panel").length) a(b.target).on("shown.bs.collapse hidden.bs.collapse", function(b) {
    ...
    initToplineMenu = function() {
        this.onscroll = function() {
            if( 0 != window.pageYOffset ){ 
                a(".top-menu").css("display", "none");
                a('#menu_nav').addClass('isNotTop');
            }else{
                a(".top-menu").css("display", "table")
                a('#menu_nav').removeClass('isNotTop');
            }
        }
    };
    moveToplineMenu = function() {
        a(window).resize(function() {
            var b = a(".nav-dropdown-sm"),
                c = a(".nav-dropdown.collapse");
            a(".top-menu");
    ...
    filterShop = function(b, c) {
        var e = 3 > c ? a(".shop-items").children().sort(function(b, d) {
            var e = parseFloat(a(b).attr("price")),
                h = parseFloat(a(d).attr("price"));
    ...
    if (0 != a(".extShop1").length) {
        var x = a(".shop-items").children(),
            l = a(".shop-items").children(),
            n = a(".sort-buttons .filter-by-pu .btn"),
            p = a(".sort-buttons .filter-by-pd .btn"),
            t = a(".sort-buttons .filter-by-d .btn");
        a(".filter-by-pu").on("click", function() {
        ...
        a(".price-range-reset").on("click", function() {
            ...
            a(".range-controls .bar").css("margin-left", "0px").css("width", "100%");
            rangeSliderInit();
        ...
        if (c.hasClass("extShop1")) {
            ...
            c.find(".mbr-gallery-item").each(function(b) {
                (a(this).attr("data-tags") || "").trim().split(",").map(function(b) {
                    b = b.trim(); - 1 == a.inArray(b, e) && e.push(b)
                })
            });
                ...
                c.on("click", ".mbr-gallery-filter li", function(b) {
                    ...
                    c.find(".mbr-gallery-item:not(.bestsellers .mbr-gallery-item)").each(function(b, c) {
                        ...
                        tagsTrimmed = d.attr("data-tags").split(",").map(function(a) {
                            return a.trim()
                        }); - 1 != a.inArray(e, tagsTrimmed) || $li.hasClass("mbr-gallery-filter-all") ? d.removeClass("mbr-gallery-item__hided") : (d.addClass("mbr-gallery-item__hided"), setTimeout(function() {
                            d.css("left", "300px")
                        }, 200))
                    });
                    setTimeout(function() {
    ...
    rangeSliderInit = function() {
        var b = a("input.min-input"),
            c = a("input.max-input"),
            e = a("div.range-controls"),
            d = e.find("div.bar"),
            g = e.find("div.min-toggle"),
            m = e.find("div.max-toggle"),
            k = d.innerWidth() - 20,
            h = 0,
            f = k,
            l = e.offset().left,
            ...
            r = c.val(),
            n = b.val(),
            p = parseInt(a(".filter-cost").width()) - 20;
        g.mousedown(function() {
            a(document).on("mousemove", function(c) {
                m.css("z-index", 0);
                g.css("z-index", 1);
                togglePos = Math.round(c.pageX - l) - 10;
                h = 0 >= togglePos ? 0 : togglePos >= k ? k : togglePos;
                g.css({
                    left: function(a, b) {
                        if (h < f) return q = h;
                        q = r;
    ...
    a("html").hasClass("is-builder") || (moveToModal = function(b) {
        var c = a(".shopItemsModal"),
            e = a(b).find(".sidebar_wraper").clone(),
            d = a(b).find("img").clone();
